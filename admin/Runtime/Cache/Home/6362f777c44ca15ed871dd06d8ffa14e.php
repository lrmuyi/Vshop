			...
			<div class="main-container-inner">
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							<a href="./index.php/Home/Index/typography">
						...
						<li>
							...
							<ul class="submenu">
								...
								<!-- <li>
									<a href="./index.php/Home/Index/jquery_ui">
										<i class="icon-double-angle-right"></i>
										jQuery UI
									</a>
								</li> -->
<!-- 
								<li>
									<a href="./index.php/Home/Index/nestable_list">
										<i class="icon-double-angle-right"></i>
										可拖拽列表
									</a>
								</li> -->
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="./index.php/Home/Index/jqgrid">
										<i class="icon-double-angle-right"></i>
										店铺订单
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="./index.php/Home/Index/form_elements">
										<i class="icon-double-angle-right"></i>
										商品分类
									</a>
								</li>
								...
								<li>
									<a href="./index.php/Home/Index/form_wizard">
										<i class="icon-double-angle-right"></i>
										商品价格
									</a>
								</li>
								...
								<li>
									<a href="./index.php/Home/Index/wysiwyg">
										<i class="icon-double-angle-right"></i>
										商品名称
									</a>
								</li>
								...
								<li>
									<a href="./index.php/Home/Index/dropzone">
										<i class="icon-double-angle-right"></i>
										商品上架
									</a>
								</li>
						...
						<li>
							<a href="./index.php/Home/Index/widgets">
						...
						<li>
							<a href="./index.php/Home/Index/calendar">
						...
						<li>
							<a href="./index.php/Home/Index/gallery">
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="<?php echo (IMG_URL); ?>user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="<?php echo (IMG_URL); ?>avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="<?php echo (IMG_URL); ?>avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="<?php echo (IMG_URL); ?>avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="<?php echo (IMG_URL); ?>avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="<?php echo (IMG_URL); ?>avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="<?php echo (IMG_URL); ?>avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="<?php echo (IMG_URL); ?>avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="<?php echo (IMG_URL); ?>avatar.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="<?php echo (IMG_URL); ?>avatar1.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="<?php echo (IMG_URL); ?>avatar2.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="<?php echo (IMG_URL); ?>avatar3.png" />
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="<?php echo (IMG_URL); ?>avatar1.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="<?php echo (IMG_URL); ?>avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="<?php echo (IMG_URL); ?>user.jpg" />
															</div>
															...
															<div class="body">
																...
																<div class="text">欢迎大家使用菜鸟V校店</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="<?php echo (IMG_URL); ?>avatar4.png" />
															</div>
...
<![endif]-->
		...
		<script src="<?php echo (JS_URL); ?>flot/jquery.flot.min.js"></script>
		<script src="<?php echo (JS_URL); ?>flot/jquery.flot.pie.min.js"></script>
		<script src="<?php echo (JS_URL); ?>flot/jquery.flot.resize.min.js"></script>

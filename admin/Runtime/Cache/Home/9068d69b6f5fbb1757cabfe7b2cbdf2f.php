...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo (CSS_URL); ?>bootstrap-timepicker.css" />
		<link rel="stylesheet" href="<?php echo (CSS_URL); ?>daterangepicker.css" />
...
<![endif]-->
		...
		<script src="<?php echo (JS_URL); ?>date-time/bootstrap-datepicker.min.js"></script>
		<script src="<?php echo (JS_URL); ?>date-time/bootstrap-timepicker.min.js"></script>
		<script src="<?php echo (JS_URL); ?>date-time/moment.min.js"></script>
		<script src="<?php echo (JS_URL); ?>date-time/daterangepicker.min.js"></script>
		<script src="<?php echo (JS_URL); ?>bootstrap-colorpicker.min.js"></script>
		<script src="<?php echo (JS_URL); ?>jquery.knob.min.js"></script>
		<script src="<?php echo (JS_URL); ?>jquery.autosize.min.js"></script>
		<script src="<?php echo (JS_URL); ?>jquery.inputlimiter.1.3.1.min.js"></script>

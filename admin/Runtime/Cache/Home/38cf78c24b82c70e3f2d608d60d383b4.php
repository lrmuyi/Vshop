...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo (CSS_URL); ?>prettify.css" />
		...
		<link rel="stylesheet" href="<?php echo (CSS_URL); ?>typo.css" />
		<!--[if lte IE 8]>
							...
							<ul class="submenu">
								<li>
									<a href="form_elements">
										<i class="icon-double-angle-right"></i> 商品分类
									</a>
								</li>

								<li>
									<a href="form_wizard">
										<i class="icon-double-angle-right"></i> 商品价格
									</a>
								</li>

								<li>
									<a href="wysiwyg">
										<i class="icon-double-angle-right"></i> 商品名称
									</a>
								</li>

								<li>
									<a href="dropzone">
										<i class="icon-double-angle-right"></i> 商品上架
									</a>
								</li>
							</ul>
						</li>
					...
					<div class="page-content">
						<div class="row">
							...
							<div class="define-title">
								<div class="define-title-box box-1">
									门店列表
								</div>
								<div class="define-title-box box-2">
									添加门店
								</div>
							</div>
							<div class="define-user-login">
								<div>
									商户登录地址：
								</div>
							</div>
							
							<div class="define-sort-box">
								<div class="sort-title">
									筛选
								</div>
								<div class="sort-box-top">
									<div class="top-title">所属分类</div>
									<select name="" class="sort-top-select">
								...
								<div class="sort-box-top">
									<div class="top-title">商户标签</div>
									<div class="sort-top-tip">
										<span>不限</span>
										<span>新店</span>
										<span>品牌</span>
									</div>
								...
								<div class="sort-box-top">
									<div class="top-title">门店名称</div>
									<div class="sort-top-name">
									</div>
								</div>
								
							</div>
							<!--sort-box-1-->
							<div class="define-sort-box-bottom">
								<div class="sort-title-bottom">
									<div class="sort-box-1">
										门店LOGO
									</div>
									<div class="sort-box-2">
										门店名称
									</div>
									<div class="sort-box-3">
										所属分类
									</div>
									<div class="sort-box-4">
										标签
									</div>
									<div class="sort-box-5">
										营业状态
									</div>
									<div class="sort-box-6">
										是否显示
									</div>
									<div class="sort-box-7">
										是否推荐
									</div>
									<div class="sort-box-8">
										热度
									</div>
									<div class="sort-box-9">
										排序
									</div>
									<div class="sort-box-10">
										操作
									</div>
								</div>
